package com.calamares.estoque.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.calamares.estoque.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.calamares.estoque.repository.UserRepository.USERS_BY_EMAIL_CACHE);
