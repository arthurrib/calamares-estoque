...
import com.calamares.estoque.repository.ProdutoRepository;
import com.calamares.estoque.service.ProdutoService;
...
/**
 * REST controller for managing {@link com.calamares.estoque.domain.Produto}.
 */
@RestController
@RequestMapping("/api")
