...
import com.calamares.estoque.repository.PedidoRepository;
import com.calamares.estoque.service.PedidoService;
...
/**
 * REST controller for managing {@link com.calamares.estoque.domain.Pedido}.
 */
@RestController
@RequestMapping("/api")
public class PedidoResource {
    ...
    public ResponseEntity<PedidoDTO> updatePedido(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, pedidoDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PedidoDTO> partialUpdatePedido(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, pedidoDTO.getId().toString())
        );
    }
